modal run -d isic2024_scd_app.py::train --model-name efficientnet_b0 --version v2 --fold 1
#Link: https://modal.com/apps/supreeth-manyam/main/ap-MlmpXsHCzorSCFt6ZCYSs0
